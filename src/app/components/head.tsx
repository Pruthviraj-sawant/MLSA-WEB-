    ...
    <div className="flex flex-col items-center w-full px-4">
      ...
      <div className="flex flex-wrap justify-center gap-2 mt-14">
        ...
        <CardContainer className="inter-var ml-12 mr-5 ">
          <CardBody  className=" relative group/card hover:shadow-2xl hover:shadow-emerald-500/[0.9] bg-black border-white/[0.2]  w-auto sm:w-[18rem] h-[30rem] rounded-xl p-6 border">
