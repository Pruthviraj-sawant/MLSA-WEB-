...
const cardData: CardData[] = [
  {
    id: 1,
    imgSrc:
      "https://coek.dypgroup.edu.in/wp-content/uploads/2024/05/image187-300x225.jpg",
    header: "General Committee interview",
    paragraph:
      "MLSA DYPCET Chapter conducted General Committee interviews to select members and raise awareness about its objectives, targeting second and third-year students, led by Prof. A.S.Yadav.",
  },
  {
    id: 2,
    imgSrc:
      "https://coek.dypgroup.edu.in/wp-content/uploads/2024/05/image189-300x271.png",
    header: "GitHub & Copilot Challenge Date ",
    paragraph:
      "The MLSA DYPCET Chapter organized a 10-day GitHub & Copilot Challenge online on Microsoft Learn platform to enhance coding skills for second and third-year students, coordinated by Mr. Aditya Marathe. No. of Participants – 30",
  },
  {
    id: 3,
    imgSrc:
      "https://coek.dypgroup.edu.in/wp-content/uploads/2024/05/image191-300x298.jpg",
    header: "AI Mastery Quest: Navigating Intelligent Realms Challenge",
    paragraph:
      "MLSA DYPCET Chapter conducted a 14-day AI Mastery Quest online, focusing on navigating intelligent realms, on Microsoft Learn platform. No of Participants – 95 Winners – Chandraprakash Maurya, Suhani Ingale",
  },
  {
    id: 4,
    imgSrc:
      "https://coek.dypgroup.edu.in/wp-content/uploads/2024/05/image193-300x225.jpg",
    header: "Orientation Of MLSA DYPCET Chapter at SY & TY CSE",
    paragraph:
      "The MLSA DYPCET Chapter held a four-day orientation in various classrooms to introduce the club to 50-60 second and third-year students, coordinated by Mr. Aditya Marathe.",
  },
  {
    id: 5,
    imgSrc:
      "https://coek.dypgroup.edu.in/wp-content/uploads/2024/05/image195-225x300.jpg",
    header: "Tech Talk (Git & GitHub) Date : 24-01-2024",
    paragraph:
      "MLSA DYPCET Chapter held a Tech Talk on Git & GitHub, featuring guest speaker Mr. Sambhaji Gade, aimed at second and third-year students, with 40 attendees.",
  },
];
...
const Slider: React.FC = () => {
  ...
  useEffect(() => {
    ...
    return () => clearInterval(intervalId);
  }, [cardData.length]); // ✅ Added dependency

  return (
    <div className="relative w-full max-w-8xl h-[30rem] mx-auto overflow-hidden">
      {/* Slider Container */}
      <div
      ...
      >
        {cardData.map((card) => (
          <div
            key={card.id}
            className="w-full flex-shrink-0 p-4 flex flex-col items-center text-center shadow-lg rounded-lg"
          >
            <Image
              src={card.imgSrc}
              alt={card.header}
              width={480}
              height={280}
              className="mb-7 w-[30rem] h-[18rem] object-cover rounded border-cyan-600 border-[5px]"
            />
            <h3 className="text-xl font-bold mb-2">{card.header}</h3>
            <p className="text-gray-700 mx-8">{card.paragraph}</p>
          </div>
        ))}
      </div>
